...
public class LeadTeamMemberController {
    ...
    public PageInfo<LeadTeamMemberNoIdCardVO> getLeadTeamMemberList(@PathVariable Long leadTeamId, Page page) {
        List<LeadTeamMemberNoIdCardVO> list = leadTeamMemberService.selectLeadTeamMemberVOListByLeadTeamId(leadTeamId, page);
