...
public class PartyMassesMatterController {
    ...
    @ApiOperation(value = "根据id更新党群服务事项")
    @HasPermission("party_masses_edit")
    @PutMapping
    ...
    @ApiOperation(value = "根据id删除党群服务事项")
    ...
    @ApiOperation(value = "根据id查询党群服务事项", notes = "根据id查询")
