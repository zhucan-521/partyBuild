...
public class PartTimeMemberController {
    ...
    public PageInfo<TabPbLeadTeamMemberDto> getLeadTeam(String orgRange,Integer rangeDeptId,String personName,Long positiveId, Page page){
        Map<String,Object> conditions = new  HashMap<>();
        conditions.put("orgRange",orgRange);
        if(rangeDeptId == null || rangeDeptId == 0){
            rangeDeptId = UserContextHolder.currentUser().getDeptId();
        }
        ...
        PageInfo<TabPbLeadTeamMemberDto> pbLeadTeamMemberDtoPageInfo = new PageInfo<>(leadTeamMemberDtos);
        return pbLeadTeamMemberDtoPageInfo;
    }
