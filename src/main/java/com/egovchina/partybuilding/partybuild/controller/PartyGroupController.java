...
public class PartyGroupController {
    ...
    @ApiOperation(value = "新增党组", notes = "新增党组", httpMethod = "POST")
    @PostMapping
    ...
    @ApiOperation(value = "新增成员到党组", notes = "新增成员到党组", httpMethod = "POST")
    @PostMapping("/members")
    ...
    @ApiOperation(value = "更新党组", notes = "更新党组", httpMethod = "PUT")
    @PutMapping
    ...
    @ApiOperation(value = "删除党组", notes = "删除党组", httpMethod = "DELETE")
    ...
    @ApiOperation(value = "移除党组成员", notes = "移除党组成员", httpMethod = "DELETE")
    ...
    @ApiOperation(value = "撤销党组", notes = "撤销党组", httpMethod = "DELETE")
    @ApiImplicitParam(name = "groupId", value = "党组ID", paramType = "path", required = true)
    ...
    @ApiOperation(value = "恢复党组", notes = "恢复党组", httpMethod = "POST")
    @ApiImplicitParam(name = "groupId", value = "党组ID", paramType = "path", required = true)
    ...
    @ApiOperation(value = "筛选指定组织中未在任何党组存在的党员（调用新增成员到党组前调用该接口）", notes = "筛选指定组织中未在任何党组存在的党员", httpMethod = "GET")
    ...
    @ApiOperation(value = "获取党组详情", notes = "获取党组详情", httpMethod = "GET")
    @ApiImplicitParam(name = "groupId", value = "党组ID", paramType = "path", required = true)
    @GetMapping("/{groupId}")
    ...
    @ApiOperation(value = "获取党组列表", notes = "获取党组列表", httpMethod = "GET")
    @GetMapping
