...
public class TabPbLeadTeamMemberController {
    ...
    @ApiOperation(value = "删除班子成员", notes = "删除班子成员", httpMethod = "GET")
    @GetMapping("/delete")
    ...
    @ApiOperation(value = "查看班子成员详情", notes = "查看班子成员详情", httpMethod = "GET")
    @GetMapping("/find")
    ...
    @ApiOperation(value = "修改班子成员", notes = "修改班子成员", httpMethod = "POST")
    @PostMapping("/update")
    ...
    @ApiOperation(value = "班子成员列表", notes = "根据班子ID查询班子成员列表", httpMethod = "GET")
    @GetMapping("/list")
    ...
    @ApiOperation(value = "按条件分页全部成员", notes = "按条件全部班子成员", httpMethod = "GET")
    @ApiImplicitParams({
