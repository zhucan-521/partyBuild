...
public class FlowOutController {
    ...
    @HasPermission(value = "party_partyFlowOut_register")
    @PostMapping
    public ReturnEntity addFlowOutMember(@Validated @RequestBody @ApiParam(value = "流出党员") FlowOutMemberDTO flowOutMemberDTO) {
    ...
    @HasPermission(value = "party_partyFlowOut_del")
    ...
    @HasPermission(value = "party_partyFlowOut_edit")
    @PutMapping
