 ...
 */
@Api(value = "在职党员社区报到", tags = {"党员-在职党员社区报到接口 朱灿"})
@RestController
...
public class TabPbPositiveRegistController {
    ...
    @PostMapping("/add")
    public ReturnEntity add(@RequestBody TabPbPositiveRegist positiveRegistList) {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        positiveRegistList.setRegistDate(format.format(positiveRegistList.getRegistDate()));
